...
\textit{Split data into training and testing data for weights, features, and language shift variable\\fit naive bayesian classifier on training features, language shift variable to classify, and weights\\predict language shift using classifier\\print confusion matrix for language shift variable\\print classification report detailing precision, recall, and f1-score\\print accuracy of classifier}

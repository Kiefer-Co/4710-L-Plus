...
Since some values in the PUMF data are marked as invalid or unavailable, some preprocessing on the data was required. Due to each record having an individual weight attached to it, rather than impute a value for the missing/invalid values, those rows were dropped instead. 
